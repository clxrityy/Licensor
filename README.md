...
<img src=".github/img/example.png" alt="Licensor App Screenshot" width="300" />
...
<img src=".github/img/example_template.gif" alt="Template Creation Gif" width="300" />
...
<img src=".github/img/example_vars.png" alt="Template Variables Screenshot" width="300" />
...
<img src=".github/img/example_search.png" alt="Template Search Screenshot" width="300" />

##### Exporting a document

- You can download the rendered document in either `.md` (Markdown) or `.txt` (Plain Text) formats.

<img src=".github/img/example_download.png" alt="Document Export Gif" width="180" />
...
<img src=".github/img/example_metadata.png" alt="Template Metadata Screenshot" width="300" />
